...
void ptFilterDM::CreateInstance()
{
  ...
  if (FInstance != nullptr)
    GInfo->Raise("FilterDM already created", PT_SRC_LOCATION);
                                    ...
                                    const QString &AGuiNamePostfix /*= ""*/)
{
  if (FFilters.contains(AUniqueName))
    GInfo->Raise("Filter name not unique: " + AUniqueName, PT_SRC_LOCATION);

  if (!FFactory->AvailableFilters().contains(AFilterId))
    GInfo->Raise("Filter for AFilterId not available: " + AFilterId, PT_SRC_LOCATION);
...
ptFilterBase *ptFilterDM::GetFilterFromName(const QString AUniqueName,
  ...
  if (!hFilter && AThrowOnNotFound)
    GInfo->Raise("Filter does not exist: " + AUniqueName, PT_SRC_LOCATION);
...
void ptFilterDM::InsertToList(const TListType AListType, ptFilterBase *AFilter) {
  ...
  switch (AListType) {
    ...
    default:         GInfo->Raise("Unknown list type.", PT_SRC_LOCATION);
  }
...
//  FNameMap.insert("ResizeScale",                     "");
  ...
  FNameMap.insert("TextureOverlayOpacity",           "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/Opacity");
  FNameMap.insert("TextureOverlaySaturation",        "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/Saturation");
  FNameMap.insert("TextureOverlayExponent",          "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/VigShape");
  FNameMap.insert("TextureOverlayInnerRadius",       "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/VigInnerRadius");
  FNameMap.insert("TextureOverlayOuterRadius",       "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/VigOuterRadius");
  FNameMap.insert("TextureOverlayRoundness",         "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/VigRoundness");
  FNameMap.insert("TextureOverlayCenterX",           "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/VigCenterX");
  FNameMap.insert("TextureOverlayCenterY",           "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/VigCenterY");
  FNameMap.insert("TextureOverlaySoftness",          "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/VigSoftness");
  FNameMap.insert("TextureOverlay2Opacity",          "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/Opacity");
  FNameMap.insert("TextureOverlay2Saturation",       "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/Saturation");
  FNameMap.insert("TextureOverlay2Exponent",         "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/VigShape");
  FNameMap.insert("TextureOverlay2InnerRadius",      "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/VigInnerRadius");
  FNameMap.insert("TextureOverlay2OuterRadius",      "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/VigOuterRadius");
  FNameMap.insert("TextureOverlay2Roundness",        "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/VigRoundness");
  FNameMap.insert("TextureOverlay2CenterX",          "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/VigCenterX");
  FNameMap.insert("TextureOverlay2CenterY",          "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/VigCenterY");
  FNameMap.insert("TextureOverlay2Softness",         "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/VigSoftness");
...
//  FNameMap.insert("AspectRatioH",                    "");
  ...
  FNameMap.insert("TextureOverlayMode",              "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/OverlayMode");
  FNameMap.insert("TextureOverlayMask",              "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/MaskMode");
  FNameMap.insert("TextureOverlay2Mode",             "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/OverlayMode");
  FNameMap.insert("TextureOverlay2Mask",             "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/MaskMode");
...
//  FNameMap.insert("InputFileNameList",               "");
  FNameMap.insert("TextureOverlayFile",              "TextureOverlay/"+Fuid::TextureOverlay1_EyeCandy+"/ImageFilePath");
  FNameMap.insert("TextureOverlay2File",             "TextureOverlay/"+Fuid::TextureOverlay2_EyeCandy+"/ImageFilePath");
