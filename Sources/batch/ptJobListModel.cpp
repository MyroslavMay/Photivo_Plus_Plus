...
void ptJobListModel::sort(int column, Qt::SortOrder order)
{
  ...
  if (order == Qt::AscendingOrder) {
    switch (column) {
      case jdFileName:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), SortByFileName);
        break;
      case jdStatus:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), SortByStatus);
        break;
      case jdOutputPath:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), SortByOutputPath);
        break;
      case jdOutputFileSuffix:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), SortByOutputFileSuffix);
        break;
      case jdInputFiles:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), SortByInputFiles);
        break;
      default:
        break;
    }
  ...
  if (order == Qt::DescendingOrder) {
    switch (column) {
      case jdFileName:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), ReverseSortByFileName);
        break;
      case jdStatus:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), ReverseSortByStatus);
        break;
      case jdOutputPath:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), ReverseSortByOutputPath);
        break;
      case jdOutputFileSuffix:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), ReverseSortByOutputFileSuffix);
        break;
      case jdInputFiles:
        std::stable_sort(m_JobList->begin(), m_JobList->end(), ReverseSortByInputFiles);
        break;
      default:
        break;
    }
