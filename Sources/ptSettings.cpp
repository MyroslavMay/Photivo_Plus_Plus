...
ptSettings::ptSettings(const short InitLevel, const QString Path) {
  ...
  const ptGuiInputItem GuiInputItems[] = {
    ...
    {"ResizeScale"                   ,ptGT_Input           ,1,1,1 ,1200  ,2   ,90000 ,100  ,0 ,tr("Pixels")             ,tr("Image size")},
    {"ResizeHeight"                  ,ptGT_Input           ,1,1,1 ,800   ,2   ,90000 ,100  ,0 ,tr("Height")             ,tr("Image height")},
    ...
    {"WebResizeScale"                ,ptGT_Input           ,1,1,1 ,1200  ,2   ,90000 ,100  ,0 ,tr("pixels")             ,tr("Image size")},
...
void ptSettings::FromDcRaw(ptDcRaw* TheDcRaw) {
  ...
  Q_ASSERT(TheDcRaw->m_MinPreMulti != 0.0f);
