...
public:
  ...
  /*! Raise an Error.*/
  [[noreturn]] void Raise(const char* AMsg, const char *ALocation = "");
  [[noreturn]] void Raise(const QString AMsg, const char *ALocation = "");
...
private:
  ...
  QElapsedTimer *FTimerComplete;
  QElapsedTimer *FTimerDiff;
};
